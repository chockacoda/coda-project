...
--
/*!50003 DROP PROCEDURE IF EXISTS `MovieAddOrEdit` */;
...
IN _movie_id INT,
IN _movie_crew varchar(100),
IN _movie_genre varchar(100),
IN _movie_name varchar(100) 
 )
BEGIN
IF
  _movie_id = 0 THEN
  INSERT INTO movie(movie_crew,movie_genre,movie_name)
  VALUES (_movie_crew,_movie_genre,_movie_name);
...
-- Dump completed on 2020-12-15 16:59:19
